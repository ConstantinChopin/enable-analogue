...
export const candidates = [
  {
    ...
    fields: [
      ...
      { label: "Legal entity", value: "Sereno Kyoto KK", snippet: "row 41 · col C", confidence: 0.88 },
      { label: "City", value: "Kyoto", snippet: "row 41 · col D", confidence: 0.97 },
      { label: "Country", value: "Japan", snippet: "row 41 · col E", confidence: 0.96 },
      { label: "Neighbourhood", value: "Higashiyama", snippet: "row 41 · col F", confidence: 0.82 },
      { label: "Address", value: "3 Kodaiji Minamimon-dori, Higashiyama-ku", snippet: "row 41 · col G", confidence: 0.9 },
      { label: "Category", value: "Hotel", snippet: "row 41 · col H", confidence: 0.94 },
      { label: "Luxury tier", value: "Luxury", snippet: "row 41 · col I — inferred from rate band", confidence: 0.71 },
      { label: "Rooms", value: "28", snippet: "row 41 · col J", confidence: 0.95 },
      { label: "Opening", value: "Spring 2027", snippet: "row 41 · col K", confidence: 0.86 },
      { label: "Check-in / out", value: "15:00 / 11:00", snippet: "row 41 · cols L–M", confidence: 0.91 },
